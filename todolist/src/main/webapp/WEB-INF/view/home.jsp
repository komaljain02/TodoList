	...
	<div class="c1">
		<div class="c3">
			...
			<a class="p1"name="hlink" onclick="display('signup')">signup</a>
			 <a class="p1" name="hlink" href="aboutme" >about me</a>
		</div>
	</div>
	<div class="c2">
		<div class="c4" id="details">
			...
			<div class="c7" id="login">
				<form>
					...
					<br> <a href="reset" class="right">forgot your password ? </a><br>
			...
			<div class="c7" id="signup">
				<s:form action="register" method="post" modelAttribute="key" >
					...
					<div class="s2">
						<div class="imag2 left"></div>
						<s:input path="uv.mail" class="bcolor2 s4 left"
							placeholder="email" />
					</div>
					<br>
					<div class="s2">
						<div class="imag1 left"></div>
						<s:password path="uv.password" class="bcolor2 s4 left"
